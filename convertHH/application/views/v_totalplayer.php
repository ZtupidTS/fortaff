	...
	<div class="col-md-12 col-md-offset-3">
		<form class="form-inline" role="form" method="post" >
			<div class="form-group">
	  		...
	  		if(isset($result))
	    		{
		  		?>	
		  			<select class="form-control" id="selectplayer">
						...
						{
							?>
							<option value="<?= $row['id_player'];?>"><?= $row['nick_player'].": ".$row['skype'];?></option>
							<?php
						}?>
					</select>
		  	...
		  	<input type="button" id="btn_search" value="Procurar" onclick="playerdia()" class="btn btn-default noPrint">
...
function playerdia()
{
	...
	var values = {datefirst: date1, datesecond: date2, id_player: player};
	var newform = createform('<?= base_url("home/searchplayerdia");?>',values);
	
	$.ajax({
	        url: '<?= base_url("home/searchplayerdia");?>',
	        type: 'post',
	        dataType: 'json',
