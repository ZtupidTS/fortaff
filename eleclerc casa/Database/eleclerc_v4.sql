...
--
-- Host: localhost
-- Generation Time: Jul 21, 2012 at 11:52 PM
...
--
-- Table structure for table `quebras_2012`
--

CREATE TABLE IF NOT EXISTS `quebras_2012` (
  `que_id` int(11) NOT NULL AUTO_INCREMENT,
  `que_fam_id` int(11) NOT NULL,
  `que_tq_id` int(11) NOT NULL,
  `que_quantity` decimal(4,3) NOT NULL,
  `que_valor` decimal(5,2) NOT NULL,
...
--
-- Dumping data for table `quebras_2012`
--

INSERT INTO `quebras_2012` (`que_id`, `que_fam_id`, `que_tq_id`, `que_quantity`, `que_valor`, `que_date`) VALUES
(1, 1, 10, '2.100', '2.10', '2012-12-12');
...
--
-- Constraints for table `quebras_2012`
--
ALTER TABLE `quebras_2012`
  ADD CONSTRAINT `quebras_2012_ibfk_1` FOREIGN KEY (`que_fam_id`) REFERENCES `family` (`fam_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `quebras_2012_ibfk_2` FOREIGN KEY (`que_tq_id`) REFERENCES `tipo_quebras` (`tq_id`) ON DELETE CASCADE ON UPDATE CASCADE;
