...
public class FileChooseJFrame extends javax.swing.JFrame {
     ...
     */
    public FileChooseJFrame(String origin) {
        initComponents();
        ...
        if (jFileChooser.showOpenDialog(this) == jFileChooser.APPROVE_OPTION)
        {
            ...
            if(Utils.equalExtension(filename, "xls"))
            {
                ImportJFrame iq = new ImportJFrame(jFileChooser.getSelectedFile().getPath(), origin);
                iq.setVisible(true);
                this.dispose();
            }else{
                Messages.messageInformation("Tem de escolher um ficheiro do tipo '*.xls'", "Informação");
                this.dispose();
            } 
        }else{
            this.dispose();
