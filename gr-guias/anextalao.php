<?php include 'includes/header.php'; ?>
    ...
    function anexTalao()
    {
        ...
        xhr.onreadystatechange=function()
        {
                if (xhr.readyState==4 && xhr.status==200)
                {
                    ...
                    if(trimStr(xhr.responseText) == 'ok')
                    {
                        ...
                        alert("Talão anexado com sucesso");
        ...
        xhr.open("POST","ajax/ajanextalao.php",true);
        ...
        <div class="col-md-7 col-md-offset-2">
            <form name="changegr" class="form-horizontal" onsubmit="return false;">
                <fieldset>
                    ...
                    <!-- Form Name -->
                    <legend>Anexar Talão a Guia</legend>
                        ...
                        <div class="form-group" id="importtalao2">
                        	<label class="col-sm-2 control-label" for="textinput"></label>
                            	<div class="col-sm-3">
                                	<input type="button" onclick="anexTalao()" class="btn btn-primary" value="Anexar">
                            	</div>
                        </div>
