<?php include 'includes/header.php'; ?>
    ...
    function recuperarGuia()
    {
        ...
        xhr.open("POST","ajax/ajrecupgr.php",true);
                ...
                <fieldset>
                    ...
                    <legend>Recuperar Guia</legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="button" onclick="recuperarGuia()" class="btn btn-primary" value="Recuperar">
                            </div>
                        </div>                        
