...
--
-- Client: localhost
-- Généré le: Dim 04 Mai 2014 à 20:50
...
CREATE TABLE IF NOT EXISTS `grep` (
  ...
  `cl_codpostal` tinyint(7) NOT NULL,
  ...
  `art_acessor` varchar(100) NOT NULL,
  `art_estetic` varchar(100) NOT NULL,
  `art_defect` varchar(200) NOT NULL,
  `art_garantie` tinyint(1) NOT NULL,
  `art_orcamento` tinyint(1) NOT NULL,
  `art_dategar` date NOT NULL,
  `art_valorcamento` tinyint(4) NOT NULL,
  `id_reparador` int(11) NOT NULL,
  `date_in` date NOT NULL,
  `date_torep` date NOT NULL,
