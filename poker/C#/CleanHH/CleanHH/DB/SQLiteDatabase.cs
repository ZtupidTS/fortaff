...
namespace CleanHH.DB
{
    class SQLiteDatabase
    {
        ...
        public SQLiteDatabase()
        {
            ...
            {
                dbConnection = "Data Source=DB/DB.sqlite";
                //e aqui caso quero alterar o que já existe
            }
            else
            {
                SQLiteConnection.CreateFile("DB/DB.sqlite");
                dbConnection = "Data Source=DB/DB.sqlite";
                ...
                ExecuteNonQuery("create table folders (id INTEGER PRIMARY KEY, name varchar(80), size BIGINT, lastmodif DATETIME)");
                ExecuteNonQuery("create table files (id INTEGER PRIMARY KEY, name varchar(80), size BIGINT, lastmodif DATETIME)");
                ExecuteNonQuery("create table numberhands (id INTEGER PRIMARY KEY, numberhand BIGINT, newnumber BIGINT)");
            }
        }
