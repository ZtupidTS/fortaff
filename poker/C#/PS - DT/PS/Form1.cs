...
namespace PS
{
    public partial class FormInicial : Form
    {
        ...
        private void FormInicial_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            w.Write("Location=" + location.ToString());
            w.WriteLine();
            w.Write("checkBox_Login=" + textBoxLogin.Text.ToString());
            w.WriteLine();
            w.Write("Vpn1=" + textBoxVpn1.Text.ToString());
            w.WriteLine();
            w.Write("Vpn2=" + textBoxVpn2.Text.ToString());
            w.WriteLine();
            w.Write("Vpn3=" + textBoxVpn3.Text.ToString());
            w.WriteLine();
            w.Write("Checkbox_zoom=" + checkBoxZoom.Checked.ToString());
            w.WriteLine();
