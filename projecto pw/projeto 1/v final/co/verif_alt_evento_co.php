...
if($_POST['designacao'] == "" || $_POST['descricao'] == "" || $_POST['preco'] == "" || $_POST['lugares_total'] == "")
{
	...
	if(!(is_numeric($_SESSION['preco'])))
	{
		...
		mysql_query("UPDATE evento SET designacao='$designacao', descricao='$descricao', data='$data', hora = '$hora_inicio', duracao_estimada = '$duracao', preco = '$preco', lugares_total = '$_POST[lugares_total]' WHERE cod_evento='$_SESSION[evento_a_alterar]'"); 
