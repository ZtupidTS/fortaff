...
if($_POST['designacao'] == "" || $_POST['descricao'] == "" || $_POST['preco'] == "" || $_POST['lugares_total'] == "")
{
	...
	if(!(is_numeric($_SESSION['preco'])))
	{
		...
		mysql_query("INSERT INTO evento (designacao, descricao, data, hora_inicio, duracao, preco, lugares_total, lugares_reservados, estado_valido) VALUES ('$designacao', '$descricao', '$data', '$hora_inicio', '$duracao', '$preco', '$_SESSION[lugares_total]', 0, 'V')");
