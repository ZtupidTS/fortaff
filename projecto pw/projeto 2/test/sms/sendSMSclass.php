...
class SendSMSclass
{
	...
	function SendSMS($message, $gsmnumbers)
	{
		$this->username = 'ricain59@gmail.com';
		$this->password = 'jre123456';
		$this->sender = 'JO2012';
		$this->message = $message;
		$this->flash = 0;
		$this->inputgsmnumbers = $gsmnumbers;
		$this->type = 'longSMS';
		$this->bookmark = '';
	...
	{
		#$this->xmldata = "<sms><authentification><username>" . $this->username . "</username><password>" . $this->password . "</password></authentification><message><sender>" . $this->sender . "</sender><text>" . $this->message . "</text><recipients>" . $this->inputgsmnumbers . "</recipients></message></sms>";
