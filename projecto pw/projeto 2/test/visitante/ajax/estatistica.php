...
<html>
	...
	{?>
		<div id="estatisticas_globais">
		<ul>
			<li>Numero total de delega&ccedil;&otilde;es :</li>
				<?php
				require_once '../../funcao/funcao_formulario.php';
				$total = (estatistica('delegacao'));
				?>
				<ol><?= $total['total'];?></ol>
			<li>Numero total de equipas :</li>
				<?php
				$total = (estatistica('equipa'));
				?>
				<ol><?= $total['total'];?></ol>
			<li>Número total de atletas :</li>
				<?php
				require_once '../../funcao/funcao_formulario.php';
				$total_M = (estatistica_sexo('dados_atletas','M'));
				$total_F = (estatistica_sexo('dados_atletas','F'));
				?>
				<ol><?= $total_M['total'];?> <img src="../images/sexo/sexo_feminino.png" alt="Feminino" title="feminino"/></ol>
				<ol><?= $total_F['total'];?> <img src="../images/sexo/sexo_masculino.png" alt="masculino" title="masculino"/></ol>
			<li>Número total de auxiliares :</li>
				<?php
				$total = (estatistica('dados_auxiliares'));
				?>
				<ol><?= $total['total'];?></ol>
			<li>Total de pessoas que assistiram aos eventos :</li>
				<?php
