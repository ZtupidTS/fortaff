...
<?php
	...
	if (isset($_SESSION['equipa_post']) and isset($_SESSION['equipa_post']['id_equipa'])) {
		$_GET['id_equipa'] = $_SESSION['equipa_post']['id_equipa'];
	...
	if (isset($_GET['id_delegacao'])) {
		$id_delegacao = $_GET['id_delegacao'];
...
?>
				<select id="input_modalidade" name="id_modalidade" disabled="disabled">
				</select>
<?php
	}
?>
...
?>
	<tr class="<?= $alt ? "rowalternative": "" ?>">
		...
		<td> 
			<form action="../elementos/edit.php" method="GET">
...
<br/>
<a href="index.php" class="seta-invertida">Voltar</a>
<?php
